...
var resourceNames = {
  ...
  azureFirewallMip: 'mip-${replace(namingBaseNoWorkloadName, resourceTypeToken, naming.resourceTypeAbbreviations.azureFirewall)}'  
  ...
  logAnalyticsWorkspaceHub: '${replace(namingBase, resourceTypeToken, naming.resourceTypeAbbreviations.logAnalyticsWorkspace)}-hub'
  logAnalyticsWorkspaceSpoke: '${replace(namingBase, resourceTypeToken, naming.resourceTypeAbbreviations.logAnalyticsWorkspace)}-spoke'
