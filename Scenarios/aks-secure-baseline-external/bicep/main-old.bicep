...
module publicIpFW 'br/public:avm/res/network/public-ip-address:0.3.1' = if (deployFirewall) {
  ...
  params: {
    name: naming.outputs.resourcesNames.azureFirewallPip
    location: location
    zones: []
...
module publicIpFWMgmt 'br/public:avm/res/network/public-ip-address:0.3.1' = if (deployFirewall) {
  ...
  params: {
    name: naming.outputs.resourcesNames.azureFirewallMip
    location: location
    zones: []
    publicIPAllocationMethod: 'Static'
    skuName: 'Standard'
...
module azureFirewall 'br/public:avm/res/network/azure-firewall:0.1.1' = if (deployFirewall) {
  scope: resourceGroup(hubResourceGroup.name)
  name: take('azfw-${deployment().name}', 64)
  params: {
